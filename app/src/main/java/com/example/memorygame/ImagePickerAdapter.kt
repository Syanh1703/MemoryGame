...
class ImagePickerAdapter(private val context : Context, private  val choseImageUri: List<Uri>, private  val intentBoardSize: BoardSize, private val imagePicker:PickImage)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val layoutParams = view.findViewById<ImageView>(R.id.ivCustomImage).layoutParams as ViewGroup.LayoutParams
